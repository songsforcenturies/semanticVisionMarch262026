#!/usr/bin/env python3
"""Generate PDF from the definitive v6 patent filing markdown."""
import re
...
OUTPUT_PATH = "/app/PROVISIONAL_PATENT_DEFINITIVE_v6.pdf"
MD_PATH = "/app/PROVISIONAL_PATENT_DEFINITIVE_v6.md"
...
def watermark(canvas, doc):
    ...
    canvas.drawString(72, 36, "Semantic Vision - Provisional Patent Application v6.0 DEFINITIVE - Allen Tyrone Johnson - March 2026")
                ...
                if table_rows:
                    ...
                    for r in table_rows:
                        while len(r) < max_cols:
                            r.append('')
                        norm_rows.append([Paragraph(escape_xml(c)[:100], small) for c in r])
                    try:
