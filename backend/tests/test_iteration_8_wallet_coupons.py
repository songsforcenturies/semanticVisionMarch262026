...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://learning-portal-v1.preview.emergentagent.com').rstrip('/')
...
class TestWalletAPIs:
    ...
    def test_wallet_topup_creates_stripe_session(self):
        ...
        response = requests.post(f"{BASE_URL}/api/wallet/topup", 
            ...
            json={
                "package_id": "small",  # $5
                "origin_url": "https://learning-portal-v1.preview.emergentagent.com"
            }
        )
